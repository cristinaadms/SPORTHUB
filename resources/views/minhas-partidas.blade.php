    ...
    <header class="bg-white shadow-sm sticky top-0 z-40">
        <div class="px-4 py-4">
            ...
            <div class="flex space-x-2 mt-4">
                ...
                <button class="px-4 py-2 bg-gray-100 text-gray-600 rounded-xl text-sm font-medium hover:bg-gray-200 transition-colors">
                    Confirmadas
                </button>
                <button class="px-4 py-2 bg-gray-100 text-gray-600 rounded-xl text-sm font-medium hover:bg-gray-200 transition-colors">
                    Pendentes
    ...
    <main class="px-4 py-6 space-y-4">
        ...
        <div class="bg-white rounded-2xl shadow-md p-4 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between mb-3">
                ...
                <button onclick="window.location.href='detalhes-partida.html'" class="bg-blue-primary hover:bg-blue-hover text-white px-4 py-2 rounded-xl font-semibold text-sm transition-colors">
                    Ver detalhes
                </button>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md p-4 hover:shadow-lg transition-shadow border-l-4 border-blue-primary">
            <div class="flex items-start justify-between mb-3">
                <div class="flex-1">
                    <div class="flex items-center space-x-2 mb-2">
