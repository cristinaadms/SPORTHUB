                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-900 font-mono text-sm">{{ $local->latitude }}, {{ $local->longitude }}</p>
                            <button onclick="abrirMapa()" class="text-blue-primary text-sm hover:text-blue-hover transition-colors mt-1">
                                Ver no mapa →
                            </button>
                        </div>
                    </div>
                    ...
                    @foreach($local->avaliacoes->take(3) as $avaliacao)
                        <div class="border-l-4 border-blue-primary pl-4">
                            <div class="flex items-center space-x-2 mb-1">
                                ...
                                <span class="text-xs text-gray-500">{{ $avaliacao->created_at->diffForHumans() }}</span>
                            </div>
        ...
        <div class="bg-white rounded-2xl shadow-md">
            <div class="p-6">
                ...
                <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="{{ Auth::user()->isAdmin() ? route('admin.index') : route('locais.public.index') }}" 
