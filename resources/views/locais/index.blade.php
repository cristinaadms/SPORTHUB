    ...
    <main class="px-4 py-6 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-md p-4 md:col-span-1 col-span-2">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $locais->where('avaliacoes_count', '>', 0)->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex space-x-2">
                    <button onclick="filtrarLocais('todos')" class="px-3 py-1 text-sm rounded-lg bg-blue-primary text-white filter-btn" data-filter="todos">Todos</button>
                    <button onclick="filtrarLocais('com-foto')" class="px-3 py-1 text-sm rounded-lg bg-gray-200 text-gray-600 hover:bg-gray-300 filter-btn" data-filter="com-foto">Com Foto</button>
                    <button onclick="filtrarLocais('recentes')" class="px-3 py-1 text-sm rounded-lg bg-gray-200 text-gray-600 hover:bg-gray-300 filter-btn" data-filter="recentes">Recentes</button>
                </div>
            </div>
        </section>
                    ...
                    <div class="p-4">
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex items-center text-sm text-gray-secondary">
                                ...
                                <span class="font-mono text-xs">{{ $local->latitude }}, {{ $local->longitude }}</span>
                            </div>
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <span class="text-sm font-medium text-gray-600">{{ number_format($local->nota_media, 1) }}</span>
                        ...
                        <!-- Botões de ação -->
                        <div class="flex space-x-2">
                            <a href="{{ route('locais.public.show', $local->id) }}" 
