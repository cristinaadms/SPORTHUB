...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="text-center text-gray-secondary mb-8">Crie sua conta</p>
        </div>
        ...
        <form class="space-y-6" method="POST" action="{{ route('register') }}">
            @csrf
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="telefone" name="telefone" type="tel" value="{{ old('telefone') }}" required
                                class="appearance-none block w-full px-3 py-3 border border-gray-300 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-blue-primary focus:border-blue-primary sm:text-sm transition-colors"
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-gray-900">
                            Aceito os <a href="#" class="text-blue-primary hover:text-blue-hover">termos de uso</a> e <a href="#" class="text-blue-primary hover:text-blue-hover">política de privacidade</a>
                        </label>
                    </div>
